 ...
 */
export declare class DocumentKeyReference<T> {
    readonly _databaseId: DatabaseId;
    readonly _key: DocumentKey;
    readonly _converter?: firestore.FirestoreDataConverter<T> | undefined;
    constructor(_databaseId: DatabaseId, _key: DocumentKey, _converter?: firestore.FirestoreDataConverter<T> | undefined);
}
