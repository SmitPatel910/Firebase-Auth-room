...
function logWarn(msg) {
    ...
    if (logClient.logLevel <= logger.LogLevel.WARN) {
        var args = obj.map(argToString);
        logClient.warn.apply(logClient, tslib.__spreadArrays(["Firestore (" + SDK_VERSION + "): " + msg], args));
    }
}
/**
...
var SyncEngine = /** @class */ (function () {
    function SyncEngine(localStore, remoteStore, datastore, 
...
var RemoteStore = /** @class */ (function () {
    ...
    RemoteStore.prototype.fillWritePipeline = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var lastBatchIdRetrieved, batch, e_7;
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
    ...
    DocumentSnapshot.prototype.data = function (options) {
        ...
        if (!this._document) {
            ...
            if (this._converter) {
                ...
                var userDataWriter = new UserDataWriter(this._firestore._databaseId, this._firestore._areTimestampsInSnapshotsEnabled(), options.serverTimestamps || 'none', function (key) { return new DocumentReference(key, _this._firestore); });
...
var GrpcConnection = /** @class */ (function () {
    ...
    GrpcConnection.prototype.openStream = function (rpcName, token) {
        ...
        grpcStream.on('error', function (grpcError) {
            logWarn(LOG_TAG$a, 'GRPC stream error. Code:', grpcError.code, 'Message:', grpcError.message);
            var code = mapCodeFromRpcCode(grpcError.code);
