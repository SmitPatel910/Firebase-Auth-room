...
var E$1 = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.R !== e) throw new I$1(E$1.ABORTED, "getToken aborted due to token change.");
            return n ? (De("string" == typeof n.accessToken), new N$1(n.accessToken, t.currentUser)) : null;
...
var S$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, P$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n.prototype.$ = function(t, e, r) {
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Q$1(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return Ue(t.arrayValue.values || [], e.arrayValue.values || [], Q$1);
...
var st = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Ue(this.elements, e.elements, Q$1);
    }, t;
}(), ut = /** @class */ function() {
    function t(t) {
        this.elements = t;
 ...
 */ var ct = /** @class */ function() {
    ...
    return t.prototype.ft = function(t) {
        ...
        return Ue(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), ft = /** @class */ function() {
...
var Nt, At, Tt = function(t, e) {
    ...
    t.prototype.canonicalId = function() {
        ...
        for (var t = 0, e = this.filters; t < e.length; t++) {
            var n = e[t];
            if (n instanceof Ut && n.ue()) return n.field;
        }
        return null;
    }, 
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        if (t.Y()) return "in" /* IN */ === e ? new Pt(t, r) : new St(t, e, r);
        if (nt(r)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Ot(t, r) : "in" /* IN */ === e ? new Lt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Mt(t, r) : new n(t, e, r);
 ...
 */ var ve = {
    ...
    t.prototype.ci = function(t) {
        ...
        // in the local target cache.
                return 4 === e.length ? U$1.H : this.wi(e);
    }, Object.defineProperty(t.prototype, "Ii", {
        get: function() {
            return new U$1([ "projects", this.ii.projectId, "databases", this.ii.database ]).j();
        },
        enumerable: !0,
        configurable: !0
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.mi = function(t, e) {
        ...
        if (0 !== t.length) {
            var n = t.map((function(t) {
                return t instanceof Ut ? e.Yi(t) : _e();
            }));
    ...
    t.prototype.Zi = function(t) {
        ...
        return Ut.create(this.on(t.fieldFilter.field), this.rn(t.fieldFilter.op), t.fieldFilter.value);
    }, 
    // visible for testing
    t.prototype.Yi = function(t) {
        if ("==" /* EQUAL */ === t.op) {
...
var je = function() {
    ...
    return t.prototype.Ir = function(t, e) {
        return this.Er.add(e), qe.resolve();
    }, t.prototype.jn = function(t, e) {
        return qe.resolve(this.Er.getEntries(e));
    }, t;
}(), ze = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.q(), n = t.O(), r = this.index[e] || new Wt(U$1.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.q(), n = t.O(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Wt(U$1.N)).W();
    }, t;
}(), Qe = /** @class */ function() {
    function t(t) {
        this.mr = t;
...
var $e = /** @class */ function() {
                  ...
                  case 0:
                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return qe.forEach(t, (function(t) {
                            return qe.forEach(t.Kn, (function(n) {
                                return c.persistence.Kh.Jh(e, t.targetId, n);
                            })).next((function() {
                                return qe.forEach(t.zn, (function(n) {
    ...
    t.prototype.io = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Th.no(n, t).next((function(i) {
                ...
                r = i, qe.resolve(r)) : e.Th.ro(n).next((function(i) {
    ...
    t.prototype.no = function(t, e) {
        var n = this.lh.get(e);
        return void 0 !== n ? qe.resolve(this.uh.get(n)) : this.Th.no(t, e);
    }, 
    /**
    ...
    t.prototype.oo = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? qe.resolve() : n.persistence.Kh.removeTarget(t, r);
        })).then((function() {
 ...
 */ var Nn = /** @class */ function() {
    ...
    function t() {
        ...
        for (var n = 0; n < t.length; ++n) if (sn("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new I$1(E$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.vo = new P$1(t);
    }
    return t.documentId = function() {
        return t.So;
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw mn("isEqual", "FieldPath", 1, e);
 ...
 * effect is the same.
 */
An.So = new An(P$1.X().j());

/**
 * Matches any characters in a field path string that are reserved.
 */
var Tn = new RegExp("[~\\*/\\[\\]]"), _n = function() {
    ...
    return __extends(n, e), n.prototype.Fo = function(t) {
        var e = new xn({
            No: 3 /* Argument */ ,
            methodName: this.Do
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), n = Bn(this.ko, e), r = new at(t.serializer, n);
        return new ft(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    ...
    return __extends(n, e), n.delete = function() {
        return en("FieldValue.delete", arguments), new Pn(new Dn("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return en("FieldValue.serverTimestamp", arguments), new Pn(new Rn("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return rn("FieldValue.arrayUnion", arguments, 1), new Pn(new Vn("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return rn("FieldValue.arrayRemove", arguments, 1), new Pn(new kn("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return sn("FieldValue.increment", "number", 1, t), nn("FieldValue.increment", arguments, 1), 
        new Pn(new Un("FieldValue.increment", t));
    }, n;
}(_n), Pn = /** @class */ function(e) {
    function n(t) {
        var n = this;
...
/** A "context" object passed around while parsing user data. */ var xn = /** @class */ function() {
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Fn(this.No) && Ln.test(t)) throw this.$o('Document fields cannot begin and end with "__"');
    }, t;
}(), jn = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.prototype.Xo = function(t, e) {
        var n = this.Jo(0 /* Set */ , t);
    ...
    /** Parse update data from an update() call. */ t.prototype.ta = function(t, e) {
        var n = this.Jo(1 /* Update */ , t);
        Qn("Data must be an object, but it was:", n, e);
        var r = [], i = new Et;
        M$1(e, (function(e, o) {
            var s = Hn(t, e), u = n.Ko(s);
            if (o instanceof _n && o.Co instanceof Dn) 
        ...
        var o = new ct(r);
        return new Cn(i.gt(), o, n.fieldTransforms);
    }, 
    /** Parse update data from a list of field/value arguments. */ t.prototype.ea = function(t, e, n, r) {
        var i = this.Jo(1 /* Update */ , t), o = [ Wn(t, e) ], s = [ n ];
        ...
        for (var u = 0; u < r.length; u += 2) o.push(Wn(t, r[u])), s.push(r[u + 1]);
        // We iterate in reverse order to pick the last value for a field if the
        // user specified the field multiple times.
        for (var a = [], h = new Et, c = o.length - 1; c >= 0; --c) if (!Yn(a, o[c])) {
            var f = o[c], l = s[c], p = i.Ko(f);
            if (l instanceof _n && l.Co instanceof Dn) 
            // Add it to the field mask, but don't add anything to updateData.
            a.push(f); else {
                var d = Bn(l, p);
        ...
        var y = new ct(a);
        return new Cn(h.gt(), y, i.fieldTransforms);
    }, 
    ...
    t.prototype.sa = function(t, e, n) {
        return void 0 === n && (n = !1), Bn(e, this.Jo(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function Bn(t, e) {
    if (zn(t)) return Qn("Unsupported field value:", e, t), Gn(t, e);
    if (t instanceof _n) 
    ...
    return function(t, e) {
        ...
        if (!Fn(e.No)) throw e.$o(t.Do + "() can only be used with update() and set()");
        if (null === e.path) throw e.$o(t.Do + "() is not currently supported inside arrays");
        var n = t.Fo(e);
...
function Gn(t, e) {
    ...
    e.path && e.path.length > 0 && e.Vt.push(e.path) : M$1(t, (function(t, r) {
        var i = Bn(r, e.Go(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function zn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof R$1 || t instanceof On || t instanceof Nn || t instanceof Mn || t instanceof _n);
}
 ...
 */ function Hn(t, e) {
    try {
        return function(t) {
            if (t.search(Tn) >= 0) throw new I$1(E$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (An.bind.apply(An, __spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
 ...
 */ var Kn = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        this.sr = t, this.ia = n, this.na = r, this.ra = i, this.listener = o, this.state = 0 /* Initial */ , 
        /**
             * A close count that's incremented every time the stream is closed; used by
             * getCloseGuardedDispatcher() to invalidate callbacks that happen after
             * close.
             */
        this.ha = 0, this.oa = null, this.stream = null, this.kr = new Be(t, e)
        /**
    ...
    t.prototype.start = function() {
        3 /* Error */ !== this.state ? this.auth() : this.ca();
    }, 
    /**
    ...
    t.prototype._a = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.ua() && null === this.oa && (this.oa = this.sr.dr(this.ia, 6e4, (function() {
            return t.fa();
        })));
    }, 
    /** Sends a message to the underlying stream. */ t.prototype.da = function(t) {
        this.wa(), this.stream.send(t);
    }, 
    /** Called by the idle timer when the stream should close due to inactivity. */ t.prototype.fa = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                return this.ua() ? [ 2 /*return*/ , this.close(0 /* Initial */) ] : [ 2 /*return*/ ];
            }));
        }));
    }, 
    /** Marks the stream as active again. */ t.prototype.wa = function() {
        this.oa && (this.oa.cancel(), this.oa = null);
    }, 
    /**
            ...
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    null !== this.stream && (this.Ta(), this.stream.close(), this.stream = null), 
                    // This state must be assigned before calling onClose() to allow the callback to
                    // inhibit backoff or otherwise manipulate the state in its non-started state.
                    this.state = t, [ 4 /*yield*/ , this.listener.Ea(r) ];
     ...
     */
    t.prototype.Ta = function() {}, t.prototype.auth = function() {
        var t = this;
        this.state = 1 /* Starting */;
        var e = this.Ia(this.ha), n = this.ha;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.ra.getToken().then((function(e) {
        ...
        var e = this, n = this.Ia(this.ha);
        this.stream = this.Aa(t), this.stream.Pa((function() {
            n((function() {
                return e.state = 2 /* Open */ , e.listener.Pa();
            }));
        })), this.stream.Ea((function(t) {
            n((function() {
                return e.Ra(t);
            }));
    ...
    t.prototype.Ia = function(t) {
        ...
        return function(n) {
            e.sr.Sr((function() {
                return e.ha === t ? n() : (Ne("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return __extends(n, e), n.prototype.Aa = function(t) {
        return this.na.Va("Listen", t);
    ...
    n.prototype.ga = function(t) {
        var e = {};
        e.database = this.serializer.Ii, e.removeTarget = t, this.da(e);
    }, n;
    ...
    return __extends(n, e), Object.defineProperty(n.prototype, "va", {
        /**
    ...
    n.prototype.start = function() {
        this.ba = !1, this.lastStreamToken = C$1.ht, e.prototype.start.call(this);
    }, n.prototype.Ta = function() {
        this.ba && this.Sa([]);
    }, n.prototype.Aa = function(t) {
        return this.na.Va("Write", t);
    }, n.prototype.onMessage = function(t) {
        if (
        // Always capture the last stream token.
        De(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.ba) {
            ...
            return this.listener.Ca(n, e);
        }
        // The first response is always the handshake response
                return De(!t.writeResults || 0 === t.writeResults.length), this.ba = !0, 
        this.listener.Da();
    }, 
    /**
    ...
    n.prototype.Fa = function() {
        ...
        var t = {};
        t.database = this.serializer.Ii, this.da(t);
    }, 
    /** Sends a group of mutations to the Firestore backend to apply. */ n.prototype.Sa = function(t) {
        var e = this, n = {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).na = t, i.credentials = n, i.serializer = r, i;
    }
    /** Gets an auth token and invokes the provided RPC. */    return __extends(n, e), n.prototype.$a = function(t, e) {
        var n = this;
    ...
    /** Gets an auth token and invokes the provided RPC with streamed results. */ n.prototype.La = function(t, e) {
        var n = this;
        return this.credentials.getToken().then((function(r) {
            return n.na.La(t, e, r);
        })).catch((function(t) {
            throw t.code === E$1.UNAUTHENTICATED && n.credentials.l(), t;
        }));
    }, n;
    ...
    function t(t) {
        ...
        this.ka = new Map, this.mutations = [], this.qa = !1, 
        /**
    ...
    return t.prototype.Ba = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.Ua(), this.mutations.length > 0) throw new I$1(E$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                            ...
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , e.La("BatchGetDocuments", i) ];
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof Dt || t instanceof _t ? i.Qa(t) : _e();
                    })), r) ];
                }
            }));
        }));
    }, t.prototype.set = function(t, e) {
        this.write(e.Qo(t, this.Rt(t))), this.xa.add(t);
    }, t.prototype.update = function(t, e) {
        try {
            this.write(e.Qo(t, this.Wa(t)));
        } catch (t) {
            this.Ma = t;
        }
        this.xa.add(t);
    }, t.prototype.delete = function(t) {
        this.write([ new gt(t, this.Rt(t)) ]), this.xa.add(t);
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.Ua(), this.Ma) throw this.Ma;
                    return t = this.ka, 
                            ...
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , e.$a("Commit", i) ];

                                  case 1:
                                    return o = n.sent(), [ 2 /*return*/ , e.serializer.ki(o.writeResults, o.commitTime) ];
                                }
                            }));
                        }));
                    }(this.Oa, this.mutations) ];

                  case 1:
                    // For each mutation, note that the doc was written.
                    return i.sent(), this.qa = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    t.prototype.Rt = function(t) {
        var e = this.ka.get(t.toString());
        return !this.xa.has(t) && e ? pt.updateTime(e) : pt.dt();
    }, 
    /**
    ...
    t.prototype.Wa = function(t) {
        ...
        this.Ua(), this.mutations = this.mutations.concat(t);
    ...
    return t.prototype.za = function() {
        var t = this;
        0 === this.Ga && (this.Ya("Unknown" /* Unknown */), this.Ha = this.Pr.dr("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
            return t.Ha = null, t.Xa("Backend didn't respond within 10 seconds."), t.Ya("Offline" /* Offline */), 
            Promise.resolve();
        })));
    }, 
    /**
    ...
    t.prototype.Ja = function(t) {
        "Online" /* Online */ === this.state ? this.Ya("Unknown" /* Unknown */) : (this.Ga++, 
        this.Ga >= 1 && (this.Za(), this.Xa("Connection failed 1 times. Most recent error: " + t.toString()), 
    ...
    t.prototype.set = function(t) {
        this.Za(), this.Ga = 0, "Online" /* Online */ === t && (
        ...
        this.Ka ? (Ae(e), this.Ka = !1) : Ne("OnlineStateTracker", e);
    }, t.prototype.Za = function() {
        null !== this.Ha && (this.Ha.cancel(), this.Ha = null);
    }, t;
}(), er = /** @class */ function() {
    function t(
    /**
    ...
    r, i, o, s) {
        ...
        /**
             ...
             * again.
             */
        this.nu = !1, this.ru = s, this.ru.hu((function(t) {
            i.Sr((function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.ou() ? (Ne("RemoteStore", "Restarting streams for network reachability change."), 
                            [ 4 /*yield*/ , this.au() ]) : [ 3 /*break*/ , 2 ];
        ...
        this.cu = function(t, e, n) {
            var r = Re(t);
            return new Xn(e, r.na, r.credentials, r.serializer, n);
        }(this.Oa, i, {
            Pa: this.lu.bind(this),
            Ea: this._u.bind(this),
            pa: this.fu.bind(this)
        }), this.du = function(t, e, n) {
            var r = Re(t);
            return new $n(e, r.na, r.credentials, r.serializer, n);
        }(this.Oa, i, {
            Pa: this.wu.bind(this),
            Ea: this.Tu.bind(this),
            Da: this.Eu.bind(this),
            Ca: this.Ca.bind(this)
        });
    }
    /**
    ...
    /** Re-enables the network. Idempotent. */ t.prototype.enableNetwork = function() {
        return this.networkEnabled = !0, this.Iu();
    }, t.prototype.Iu = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.ou() ? (this.mu() ? this.Ru() : this.uu.set("Unknown" /* Unknown */), 
                    [ 4 /*yield*/ , this.Au() ]) : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.disableNetwork = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.networkEnabled = !1, [ 4 /*yield*/ , this.Pu() ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.du.stop() ];

                  case 1:
                    return t.sent(), [ 4 /*yield*/ , this.cu.stop() ];

                  case 2:
                    return t.sent(), this.eu.length > 0 && (Ne("RemoteStore", "Stopping write stream with " + this.eu.length + " pending writes"), 
                    this.eu = []), this.Vu(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, t.prototype.pu = function() {
    ...
    t.prototype.listen = function(t) {
        ...
        this.su.set(t.targetId, t), this.mu() ? 
        // The listen will be sent in onWatchStreamOpen
        this.Ru() : this.cu.ua() && this.yu(t));
    }, 
    /**
    ...
    t.prototype.gu = function(t) {
        this.su.delete(t), this.cu.ua() && this.bu(t), 0 === this.su.size && (this.cu.ua() ? this.cu._a() : this.ou() && 
    ...
    t.prototype.yu = function(t) {
        this.iu.Ns(t.targetId), this.cu.ya(t);
    }, 
    /**
    ...
    t.prototype.bu = function(t) {
        this.iu.Ns(t), this.cu.ga(t);
    }, t.prototype.Ru = function() {
        this.iu = new pe(this), this.cu.start(), this.uu.za();
    }, 
    /**
    ...
    t.prototype.mu = function() {
        return this.ou() && !this.cu.aa() && this.su.size > 0;
    }, t.prototype.ou = function() {
        return !this.nu && this.isPrimary && this.networkEnabled;
    ...
    }, t.prototype.fu = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, i, o;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.uu.set("Online" /* Online */), !(t instanceof fe && 2 /* Removed */ === t.state && t.cause)) 
                  ...
                  case 6:
                    if (t instanceof he ? this.iu.Bs(t) : t instanceof ce ? this.iu.zs(t) : this.iu.Ws(t), 
                    r.isEqual(V$1.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;

                  case 7:
                    return n.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.tu.qh() ];

                  case 8:
                    return i = n.sent(), r.S(i) >= 0 ? [ 4 /*yield*/ , this.Du(r) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return Ne("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.Cu(o) ];
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    ...
                    return this.nu = !0, [ 4 /*yield*/ , this.Pu() ];
                        ...
                        return __awaiter(i, void 0, void 0, (function() {
                            return __generator(this, (function(t) {
                                switch (t.label) {
                                  ...
                                  case 1:
                                    return t.sent(), this.nu = !1, [ 4 /*yield*/ , this.Iu() ];
        ...
        return n.as.forEach((function(n, r) {
            if (n.resumeToken.rt() > 0) {
                ...
                // A watched target might have been removed already.
                                i && e.su.set(r, i.Ie(n.resumeToken, t));
            }
        })), 
    ...
    t.prototype.Au = function() {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    t = this.eu.length > 0 ? this.eu[this.eu.length - 1].batchId : -1, n.label = 1;

                  case 1:
                    if (!this.$u()) return [ 3 /*break*/ , 7 ];
                    n.label = 2;

                  case 2:
                    return n.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , this.tu.to(t) ];

                  case 3:
                    return null === (e = n.sent()) ? (0 === this.eu.length && this.du._a(), [ 3 /*break*/ , 7 ]) : (t = e.batchId, 
                    this.Lu(e), [ 3 /*break*/ , 6 ]);

                  case 4:
                    return r = n.sent(), [ 4 /*yield*/ , this.Cu(r) ];
                  ...
                  case 7:
                    return this.Ou() && this.ku(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.$u = function() {
        return this.ou() && this.eu.length < 10;
    }, 
    // For testing
    ...
    t.prototype.Lu = function(t) {
        this.eu.push(t), this.du.ua() && this.du.va && this.du.Sa(t.mutations);
    }, t.prototype.Ou = function() {
        return this.ou() && !this.du.aa() && this.eu.length > 0;
    }, t.prototype.ku = function() {
        this.du.start();
    }, t.prototype.wu = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                return this.du.Fa(), [ 2 /*return*/ ];
            }));
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                ...
                for (t = 0, e = this.eu; t < e.length; t++) r = e[t], this.du.Sa(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Ca = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, i, o = this;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.eu.shift(), i = Me.from(e, t, r), [ 4 /*yield*/ , this.Fu((function() {
                        return o.vu.Mu(i);
                    })) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return t && this.du.va ? [ 4 /*yield*/ , this.xu(t) ] : [ 3 /*break*/ , 2 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return jt(r = t.code) && r !== E$1.ABORTED ? (e = this.eu.shift(), 
                    // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    this.du.la(), [ 4 /*yield*/ , this.Fu((function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.sent(), this.uu.set("Unknown" /* Unknown */), [ 4 /*yield*/ , this.enableNetwork() ];
            ...
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    Ne("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.au() ]) : [ 3 /*break*/ , 2 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return (e = t) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.Pu() ];
    ...
    function t() {
        this.Ku = new nr, this.zu = {}, this.vu = null, this.ja = null, this.Xn = null;
    }
    return t.prototype.Yu = function(t) {
        ...
        return this.Ku.ju(t), this.zu[t] || "not-current";
        ...
        return this.Ku.activeTargetIds;
    }, t.prototype.nc = function(t) {
        return this.Ku.activeTargetIds.has(t);
    }, t.prototype.start = function() {
        return this.Ku = new nr, Promise.resolve();
    ...
    e) {
        this.query = t, this.hc = e, this.oc = null, 
        /**
        ...
        this.ns = ee(), this.uc = new ie(t.se.bind(t));
    }
    return Object.defineProperty(t.prototype, "cc", {
        /**
    ...
    t.prototype.lc = function(t, e) {
        var n = this, r = e ? e._c : new oe, i = e ? e.uc : this.uc, o = e ? e.ns : this.ns, s = i, u = !1, a = this.query.oe() && i.size === this.query.limit ? i.last() : null, h = this.query.ae() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.wc = function(t, e, n) {
        var r = this, i = this.uc;
        this.uc = t.uc, this.ns = t.ns;
        ...
        var s = e ? this.Ec() : [], u = 0 === this.ac.size && this.ds ? 1 /* Synced */ : 0 /* Local */ , a = u !== this.oc;
        return this.oc = u, 0 !== o.length || a ? {
            snapshot: new se(this.query, t.uc, i, o, t.ns, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Ic: s
        } : {
            Ic: s
    ...
    t.prototype.Rc = function(t) {
        ...
        return !this.hc.has(t) && 
        // The local store doesn't think it's a result, so it shouldn't be in limbo.
        !!this.uc.has(t) && !this.uc.get(t).At;
    }, 
    /**
    ...
    t.prototype.Tc = function(t) {
        ...
        t && (t.ws.forEach((function(t) {
            return e.hc = e.hc.add(t);
        })), t.Ts.forEach((function(t) {})), t.Es.forEach((function(t) {
            return e.hc = e.hc.delete(t);
        })), this.ds = t.ds);
        ...
        // updating many documents.
                var e = this.ac;
        this.ac = ee(), this.uc.forEach((function(e) {
            t.Rc(e.key) && (t.ac = t.ac.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.ac.has(e) || n.push(new or(e));
        })), this.ac.forEach((function(t) {
    ...
    t.prototype.Ac = function(t) {
        this.hc = t.co, this.ac = ee();
        var e = this.lc(t.documents);
        return this.wc(e, /*updateLimboDocuments=*/ !0);
    }, 
    /**
    ...
    t.prototype.Pc = function() {
        return se.os(this.query, this.uc, this.ns, 0 /* Local */ === this.oc);
    }, t;
}(), ur = /** @class */ function() {
    function t(t, e, n, r) {
        this.Pr = t, this.Oa = e, this.updateFunction = n, this.yr = r, this.Vc = 5, this.kr = new Be(this.Pr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.pc = function() {
        ...
        this.kr.lr((function() {
            return __awaiter(t, void 0, void 0, (function() {
                var t, e, r = this;
                return __generator(this, (function(n) {
                    return t = new Zn(this.Oa), (e = this.gc(t)) && e.then((function(e) {
                        r.Pr.Sr((function() {
        ...
        var e = this;
        this.Vc > 0 && this.vc(t) ? (this.Vc -= 1, this.Pr.Sr((function() {
            return e.yc(), Promise.resolve();
        }))) : this.yr.reject(t);
...
n) {
    ...
    r, i, o) {
        this.tu = t, this.Cc = e, this.Oa = n, this.Dc = r, this.currentUser = i, this.Fc = o, 
        this.Nc = null, this.$c = new Oe((function(t) {
            return t.canonicalId();
        })), this.Lc = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.kc = new Gt(O$1.N), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.qc = new Map, this.Mc = new Ze, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.xc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Bc = new Map, this.Uc = Qe.Ar(), this.onlineState = "Unknown" /* Unknown */;
    }
    return Object.defineProperty(t.prototype, "Qc", {
        get: function() {
            return !0;
        },
        enumerable: !0,
    ...
    t.prototype.listen = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Wc("listen()"), (i = this.$c.get(t)) ? (
                    ...
                    e = i.targetId, this.Dc.Ju(e), r = i.view.Pc(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.tu.io(t.ee()) ];

                  case 2:
                    return o = n.sent(), s = this.Dc.Ju(o.targetId), e = o.targetId, [ 4 /*yield*/ , this.jc(t, e, "current" === s) ];

                  case 3:
                    r = n.sent(), this.Qc && this.Cc.listen(o), n.label = 4;
     ...
     * snapshot.
     */
    t.prototype.jc = function(t, r, i) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, o, s, u, a, h;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.tu.ao(t, 
                    /* usePreviousResults= */ !0) ];

                  case 1:
                    return e = n.sent(), o = new sr(t, e.co), s = o.lc(e.documents), u = ae.fs(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.wc(s, 
                    /* updateLimboDocuments= */ this.Qc, u), this.Gc(r, a.Ic), h = new ar(t, r, o), 
                    [ 2 /*return*/ , (this.$c.set(t, h), this.Lc.has(r) ? this.Lc.get(r).push(t) : this.Lc.set(r, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
    }, 
    /** Stops listening to the query. */ t.prototype.gu = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, r, i = this;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.Wc("unlisten()"), e = this.$c.get(t), (r = this.Lc.get(e.targetId)).length > 1 ? [ 2 /*return*/ , (this.Lc.set(e.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.$c.delete(t)) ] : this.Qc ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.Dc.tc(e.targetId), this.Dc.nc(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.tu.oo(e.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.Dc.sc(e.targetId), i.Cc.gu(e.targetId), i.Hc(e.targetId);
                    })).catch(Je) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.Hc(e.targetId), [ 4 /*yield*/ , this.tu.oo(e.targetId, 
    ...
    t.prototype.write = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Wc("write()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.tu.gh(t) ];

                  case 2:
                    return e = n.sent(), this.Dc.Yu(e.batchId), this.Kc(e.batchId, r), [ 4 /*yield*/ , this.zc(e.vh) ];

                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.Cc.Au() ];
    ...
    t.prototype.runTransaction = function(t, e, n) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Wc("applyRemoteEvent()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.tu.Mh(t) ];
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        De(t.ws.size + t.Ts.size + t.Es.size <= 1), t.ws.size > 0 ? n.Sc = !0 : t.Ts.size > 0 ? De(n.Sc) : t.Es.size > 0 && (De(n.Sc), 
                        n.Sc = !1));
                    })), [ 4 /*yield*/ , this.zc(e, t) ];
    ...
    t.prototype.mc = function(t, e) {
        this.Wc("applyOnlineStateChange()");
        var n = [];
        this.$c.forEach((function(e, r) {
            var i = r.view.mc(t);
            i.snapshot && n.push(i.snapshot);
        })), this.Nc.Yc(t), this.Nc.pa(n), this.onlineState = t;
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Wc("rejectListens()"), 
                    // PORTING NOTE: Multi-tab only.
                    this.Dc.Zu(t, "rejected", r), e = this.qc.get(t), (i = e && e.key) ? (o = (o = new Gt(O$1.N)).Re(i, new Dt(i, V$1.min())), 
                  ...
                  case 1:
                    ...
                    this.kc = this.kc.remove(i), this.qc.delete(t), this.Xc(), [ 3 /*break*/ , 4 ];

                  case 2:
                    return [ 4 /*yield*/ , this.tu.oo(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.Hc(t, r);
                    })).catch(Je) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Wc("applySuccessfulWrite()"), e = t.batch.batchId, n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.tu.Sh(t) ];
                  ...
                  case 2:
                    ...
                    this.Jc(e, /*error=*/ null), this.Zc(e), this.Dc.Xu(e, "acknowledged"), [ 4 /*yield*/ , this.zc(r) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Wc("rejectFailedWrite()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.tu.$h(t) ];
                  ...
                  case 2:
                    ...
                    // listen events.
                    this.Jc(t, r), this.Zc(t), this.Dc.Xu(t, "rejected", r), [ 4 /*yield*/ , this.zc(e) ];
    ...
    t.prototype.tl = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Cc.ou() || Ne("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.tu.kh() ];

                  case 2:
                    return -1 === (e = n.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.Bc.get(e) || []).push(t), 
                    this.Bc.set(e, r), [ 3 /*break*/ , 4 ]);
    ...
    t.prototype.Zc = function(t) {
        (this.Bc.get(t) || []).forEach((function(t) {
            t.resolve();
        })), this.Bc.delete(t);
    }, 
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.el = function(t) {
        this.Bc.forEach((function(e) {
            e.forEach((function(e) {
        ...
        n || (n = new Gt(ke)), n = n.Re(t, e), this.xc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Jc = function(t, e) {
        ...
        var n = this;
        void 0 === e && (e = null), this.Dc.tc(t);
        for (var r = 0, i = this.Lc.get(t); r < i.length; r++) {
            var o = i[r];
            this.$c.delete(o), e && this.Nc.sl(o, e);
        }
        this.Lc.delete(t), this.Qc && this.Mc.Ro(t).forEach((function(t) {
            n.Mc.Vo(t) || 
        ...
        var e = this.kc.get(t);
        null !== e && (this.Cc.gu(e), this.kc = this.kc.remove(t), this.qc.delete(e), this.Xc());
    }, t.prototype.Gc = function(t, e) {
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof ir ? (this.Mc.Jh(i.key, t), this.nl(i)) : i instanceof or ? (Ne("SyncEngine", "Document no longer in limbo: " + i.key), 
            this.Mc.Zh(i.key, t), this.Mc.Vo(i.key) || 
            // We removed the last reference for this key
            this.il(i.key)) : _e();
        }
    }, t.prototype.nl = function(t) {
        var e = t.key;
        this.kc.get(e) || (Ne("SyncEngine", "New document in limbo: " + e), this.Oc.push(e), 
        this.Xc());
    }, 
    /**
    ...
    t.prototype.Xc = function() {
        for (;this.Oc.length > 0 && this.kc.size < this.Fc; ) {
            var t = this.Oc.shift(), e = this.Uc.next();
            this.qc.set(e, new hr(t)), this.kc = this.kc.Re(t, e), this.Cc.listen(new Ft(kt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , xe.er));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.hl = function() {
        return this.Oc;
    }, t.prototype.zc = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, i, o, s = this;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.$c.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            var e = u.view.lc(t);
                            return e.dc ? s.tu.ao(u.query, /* usePreviousResults= */ !1).then((function(t) {
                                var n = t.documents;
                                return u.view.lc(n, e);
                            })) : e;
                            // The query has a limit and some docs were removed, so we need
                            // to re-run the query against the local store to make sure we
                            // didn't lose any good docs that had been past the limit.
                                                })).then((function(t) {
                            var n = r && r.as.get(u.targetId), o = u.view.wc(t, 
                            /* updateLimboDocuments= */ s.Qc, n);
                            if (s.Gc(u.targetId, o.Ic), o.snapshot) {
                                s.Qc && s.Dc.Zu(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), e.push(o.snapshot);
                  ...
                  case 1:
                    return n.sent(), this.Nc.pa(e), [ 4 /*yield*/ , this.tu.Xh(i) ];
    ...
    }, t.prototype.Wc = function(t) {}, t.prototype.Qu = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , this.tu.Ah(t) ];

                  case 1:
                    return e = n.sent(), this.currentUser = t, 
                    // Fails tasks waiting for pending writes requested by previous user.
                    this.el("'waitForPendingWrites' promise is rejected due to a user change."), 
                    // TODO(b/114226417): Consider calling this only in the primary tab.
                    this.Dc.Ah(t, e.ph, e.yh), [ 4 /*yield*/ , this.zc(e.Vh) ];

                  case 2:
                    n.sent(), n.label = 3;

                  case 3:
                    return [ 4 /*yield*/ , this.Cc.Qu() ];
        ...
        return this.Cc.enableNetwork();
    }, t.prototype.disableNetwork = function() {
        return this.Cc.disableNetwork();
    }, t.prototype.ei = function(t) {
        var e = this.qc.get(t);
        if (e && e.Sc) return ee().add(e.key);
        var n = ee(), r = this.Lc.get(t);
        if (!r) return n;
        for (var i = 0, o = r; i < o.length; i++) {
            var s = o[i], u = this.$c.get(s);
            n = n.ze(u.view.cc);
        }
        return n;
    }, t;
}(), fr = function() {
    this.ol = void 0, this.al = [];
}, lr = /** @class */ function() {
    function t(t) {
        this.vu = t, this.ul = new Oe((function(t) {
            return t.canonicalId();
        })), this.onlineState = "Unknown" /* Unknown */ , this.cl = new Set, this.vu.subscribe(this);
    }
    return t.prototype.listen = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.ul.get(e)) || (r = !0, i = new fr), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;
                  ...
                  case 4:
                    return this.ul.set(e, i), i.al.push(t), 
                    // Run global snapshot listeners if a consistent snapshot has been emitted.
                    t.mc(this.onlineState), i.ol && t.ll(i.ol) && this._l(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, t.prototype.gu = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, r, i, o;
            return __generator(this, (function(n) {
                return e = t.query, r = !1, (i = this.ul.get(e)) && (o = i.al.indexOf(t)) >= 0 && (i.al.splice(o, 1), 
                r = 0 === i.al.length), r ? [ 2 /*return*/ , (this.ul.delete(e), this.vu.gu(e)) ] : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.pa = function(t) {
        for (var e = !1, n = 0, r = t; n < r.length; n++) {
            var i = r[n], o = i.query, s = this.ul.get(o);
            if (s) {
                for (var u = 0, a = s.al; u < a.length; u++) {
                    a[u].ll(i) && (e = !0);
                }
                s.ol = i;
            }
        ...
        var n = this.ul.get(t);
        if (n) for (var r = 0, i = n.al; r < i.length; r++) {
            i[r].onError(e);
        }
        ...
        this.onlineState = t;
        var e = !1;
        this.ul.forEach((function(n, r) {
            for (var i = 0, o = r.al; i < o.length; i++) {
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                o[i].mc(t) && (e = !0);
            }
        })), e && this._l();
    ...
    t.prototype._l = function() {
        this.cl.forEach((function(t) {
            t.next();
        }));
    }, t;
}(), pr = /** @class */ function() {
    function t(t, e, n) {
        this.query = t, this.wl = e, 
        /**
             * Initial snapshots (e.g. from cache) may not be propagated to the wrapped
             * observer. This flag is set to true once we've actually raised an event.
             */
        this.Tl = !1, this.El = null, this.onlineState = "Unknown" /* Unknown */ , this.options = n || {}
        /**
    ...
    return t.prototype.ll = function(t) {
        ...
        var o = !1;
        return this.Tl ? this.Il(t) && (this.wl.next(t), o = !0) : this.ml(t, this.onlineState) && (this.Rl(t), 
        o = !0), this.El = t, o;
    }, t.prototype.onError = function(t) {
        this.wl.error(t);
    }, 
    /** Returns whether a snapshot was raised. */ t.prototype.mc = function(t) {
        this.onlineState = t;
        var e = !1;
        return this.El && !this.Tl && this.ml(this.El, t) && (this.Rl(this.El), e = !0), 
        e;
        ...
        // above) and are waiting for a sync.
                return !(this.options.Al && n || t.docs.M() && "Offline" /* Offline */ !== e);
        ...
        var e = this.El && this.El.hasPendingWrites !== t.hasPendingWrites;
        return !(!t.rs && !e) && !0 === this.options.includeMetadataChanges;
        // Generally we should have hit one of the cases above, but it's possible
        // to get here if there were only metadata docChanges and they got
        // stripped out.
        }, t.prototype.Rl = function(t) {
        t = se.os(t.query, t.docs, t.ns, t.fromCache), this.Tl = !0, this.wl.next(t);
    }, t;
}(), dr = /** @class */ function() {
    function t() {}
    return t.prototype.Rh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(V$1.min()) ? this.Vl(t, e) : this.Pl.qn(t, r).next((function(o) {
            var u = i.pl(e, o);
            return (e.oe() || e.ae()) && i.dc(e.xt, u, r, n) ? i.Vl(t, e) : (Ie() <= LogLevel.DEBUG && Ne("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            i.Pl.Bn(t, e, n).next((function(t) {
    ...
    function t(t, e) {
        ...
        this.gl = new Wt(tn.do);
    }
    return t.prototype.bl = function(t) {
        return qe.resolve(0 === this.Dn.length);
    }, t.prototype.bh = function(t, e, n, r) {
        var i = this.yl;
        this.yl++, this.Dn.length > 0 && this.Dn[this.Dn.length - 1];
        var o = new Le(i, e, n, r);
        this.Dn.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.gl = this.gl.add(new tn(a.key, i)), this.Fn.Ir(t, a.key.path.O());
        }
        return qe.resolve(o);
    }, t.prototype.Lh = function(t, e) {
        return qe.resolve(this.vl(e));
    }, t.prototype.eo = function(t, e) {
        var n = e + 1, r = this.Sl(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return qe.resolve(this.Dn.length > i ? this.Dn[i] : null);
    }, t.prototype.kh = function() {
        return qe.resolve(0 === this.Dn.length ? -1 : this.yl - 1);
    }, t.prototype.Ph = function(t) {
        return qe.resolve(this.Dn.slice());
    }, t.prototype.$n = function(t, e) {
        var n = this, r = new tn(e, 0), i = new tn(e, Number.POSITIVE_INFINITY), o = [];
        return this.gl.Ge([ r, i ], (function(t) {
            var e = n.vl(t.po);
            o.push(e);
        })), qe.resolve(o);
        ...
        return e.forEach((function(t) {
            ...
            n.gl.Ge([ e, i ], (function(t) {
                r = r.add(t.po);
            }));
        })), qe.resolve(this.Cl(r));
        ...
        var n = this;
        De(0 === this.Dl(e.batchId, "removed")), this.Dn.shift();
        var r = this.gl;
        return qe.forEach(e.mutations, (function(i) {
            var o = new tn(i.key, e.batchId);
            return r = r.delete(o), n.Kh.Fl(t, i.key);
        })).next((function() {
            n.gl = r;
        }));
    }, t.prototype.Nl = function(t) {
        ...
        var n = new tn(e, 0), r = this.gl.Ke(n);
        return qe.resolve(e.isEqual(r && r.key));
    }, t.prototype.Nh = function(t) {
        return this.Dn.length, qe.resolve();
    }, 
    /**
    ...
    return t.prototype.Gh = function(t, e, n) {
        var r = e.key, i = this.docs.get(r), o = i ? i.size : 0, s = this.$l(e);
    ...
    t.prototype.jh = function(t) {
        ...
        return qe.resolve(n ? n.Ll : null);
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = Xt();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.Re(t, e ? e.Ll : null);
        })), qe.resolve(r);
    }, t.prototype.Bn = function(t, e, n) {
        ...
        ; o.$e(); ) {
            var s = o.Ne(), u = s.key, a = s.value, h = a.Ll, c = a.readTime;
 ...
 */
vr.kl = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Wl = t, n;
    }
    return __extends(n, e), n.prototype.wc = function(t) {
        var e = this, n = [];
        return this.vh.forEach((function(r, i) {
            i ? n.push(e.Wl.Gh(t, i, e.readTime)) : e.Wl.jh(r);
        })), qe.vn(n);
    }, n.prototype.Ul = function(t, e) {
        return this.Wl.On(t, e);
    }, n.prototype.Ql = function(t, e) {
        return this.Wl.getEntries(t, e);
    }, n;
}(/** @class */ function() {
    function t() {
    ...
    t.prototype.Gh = function(t, e) {
        this.Bl(), this.readTime = e, this.vh.set(t.key, t);
    }, 
    /**
    ...
    t.prototype.jh = function(t, e) {
        this.Bl(), e && (this.readTime = e), this.vh.set(t, null);
    }, 
    /**
    ...
    t.prototype.On = function(t, e) {
        this.Bl();
        var n = this.vh.get(e);
        return void 0 !== n ? qe.resolve(n) : this.Ul(t, e);
    }, 
    /**
     ...
     */
    t.prototype.apply = function(t) {
        return this.Bl(), this.Ml = !0, this.wc(t);
    }, 
    /** Helper to assert this.changes is not null  */ t.prototype.Bl = function() {}, 
    t;
}());
...
var mr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Hl = new Ze, this.targetCount = 0, this.Kl = Qe.Rr();
    }
    return t.prototype.js = function(t, e) {
        return this.jl.forEach((function(t, n) {
            return e(n);
        })), qe.resolve();
    }, t.prototype.qh = function(t) {
        return qe.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.zl = function(t) {
        return qe.resolve(this.Gl);
    }, t.prototype.ro = function(t) {
        return this.highestTargetId = this.Kl.next(), qe.resolve(this.highestTargetId);
    }, t.prototype.zh = function(t, e, n) {
        return n && (this.lastRemoteSnapshotVersion = n), e > this.Gl && (this.Gl = e), 
        qe.resolve();
    }, t.prototype.Yl = function(t) {
        this.jl.set(t.target, t);
        var e = t.targetId;
        e > this.highestTargetId && (this.Kl = new Qe(e), this.highestTargetId = e), t.sequenceNumber > this.Gl && (this.Gl = t.sequenceNumber);
    }, t.prototype.ho = function(t, e) {
        return this.Yl(e), this.targetCount += 1, qe.resolve();
    }, t.prototype.Wh = function(t, e) {
        return this.Yl(e), qe.resolve();
    }, t.prototype.Xl = function(t, e) {
        return this.jl.delete(e.target), this.Hl.Ro(e.targetId), this.targetCount -= 1, 
        qe.resolve();
    }, t.prototype.Jl = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.jl.forEach((function(s, u) {
            u.sequenceNumber <= e && null === n.get(u.targetId) && (r.jl.delete(s), o.push(r.Zl(t, u.targetId)), 
            i++);
        })), qe.vn(o).next((function() {
            return i;
        }));
    }, t.prototype.t_ = function(t) {
        return qe.resolve(this.targetCount);
    }, t.prototype.no = function(t, e) {
        var n = this.jl.get(e) || null;
        return qe.resolve(n);
    }, t.prototype.Bh = function(t, e, n) {
        return this.Hl.Eo(e, n), qe.resolve();
        ...
        return this.Hl.Ro(e), qe.resolve();
    }, t.prototype.uo = function(t, e) {
        var n = this.Hl.Po(e);
        return qe.resolve(n);
    }, t.prototype.Vo = function(t, e) {
        return qe.resolve(this.Hl.Vo(e));
    }, t;
}(), gr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.e_ = {}, this.s_ = new xe(0), this.i_ = !1, this.i_ = !0, this.Kh = t(this), 
        this.Th = new mr(this), this.Fn = new Ge, this.Cn = new vr(this.Fn, (function(t) {
            return e.Kh.n_(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        return this.i_ = !1, Promise.resolve();
        ...
        var e = this.e_[t.s()];
        return e || (e = new yr(this.Fn, this.Kh), this.e_[t.s()] = e), e;
        ...
        var i = new wr(this.s_.next());
        return this.Kh.o_(), n(i).next((function(t) {
            return r.Kh.a_(i).next((function() {
                return t;
            }));
        })).gn().then((function(t) {
            return i.u_(), t;
        ...
        return qe.Sn(Object.values(this.e_).map((function(n) {
            return function() {
                return n.Vo(t, e);
            };
        })));
    ...
    return t.w_ = function(e) {
        return new t(e);
    }, Object.defineProperty(t.prototype, "T_", {
        get: function() {
            if (this.d_) return this.d_;
            throw _e();
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.Jh = function(t, e, n) {
        return this.f_.Jh(n, e), this.T_.delete(n), qe.resolve();
    }, t.prototype.Zh = function(t, e, n) {
        return this.f_.Zh(n, e), this.T_.add(n), qe.resolve();
    }, t.prototype.Fl = function(t, e) {
        return this.T_.add(e), qe.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        this.f_.Ro(e.targetId).forEach((function(t) {
            return n.T_.add(t);
        }));
        ...
        // Remove newly orphaned documents.
                return qe.forEach(this.T_, (function(r) {
            return e.E_(t, r).next((function(t) {
                t || n.jh(r);
            }));
        })).next((function() {
            return e.d_ = null, n.apply(t);
        }));
    }, t.prototype.Hh = function(t, e) {
        var n = this;
        return this.E_(t, e).next((function(t) {
            t ? n.T_.delete(e) : n.T_.add(e);
        }));
        ...
        var n = this;
        return qe.Sn([ function() {
            return qe.resolve(n.f_.Vo(e));
        }, function() {
            return n.persistence.Eh().Vo(t, e);
        }, function() {
            return n.persistence.c_(t, e);
        } ]);
    }, t;
}(), Er = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Ir = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Dc = this.I_(t), this.persistence = this.m_(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return n.sent(), this.R_ = this.A_(t), this.tu = this.P_(t), this.Cc = this.V_(t), 
                    this.vu = this.p_(t), this.y_ = this.g_(t), this.Dc.ja = function(t) {
                        return e.vu.mc(t, 1 /* SharedClientState */);
                    }, this.Cc.vu = this.vu, [ 4 /*yield*/ , this.tu.start() ];

                  case 2:
                    return n.sent(), [ 4 /*yield*/ , this.Dc.start() ];

                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.Cc.start() ];

                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.Cc.Wu(this.vu.Qc) ];
        ...
        return new lr(this.vu);
    }, t.prototype.A_ = function(t) {
        return null;
    }, t.prototype.P_ = function(t) {
        return new $e(this.persistence, new dr, t.b_);
    }, t.prototype.m_ = function(t) {
        if (t.S_.v_) throw new I$1(E$1.FAILED_PRECONDITION, Er);
        return new gr(br.w_);
    }, t.prototype.V_ = function(t) {
        var e = this;
        return new er(this.tu, t.Oa, t.Pr, (function(t) {
            return e.vu.mc(t, 0 /* RemoteStore */);
        }), t.platform.C_());
    }, t.prototype.I_ = function(t) {
        return new rr;
    }, t.prototype.p_ = function(t) {
        return new cr(this.tu, this.Cc, t.Oa, this.Dc, t.b_, t.Fc);
    }, t.prototype.clearPersistence = function(t) {
        throw new I$1(E$1.FAILED_PRECONDITION, Er);
    }, t;
}(), Nr = /** @class */ function() {
    function t(t, e, n, 
    /**
     ...
     */
    r) {
        this.platform = t, this.D_ = e, this.credentials = n, this.Pr = r, this.clientId = Ve.cn()
        /**
    ...
    /** Enables the network connection and requeues all pending operations. */ t.prototype.enableNetwork = function() {
        var t = this;
        return this.F_(), this.Pr.enqueue((function() {
            return t.vu.enableNetwork();
        }));
    }, 
    /**
    ...
    t.prototype.N_ = function(t, r, i, o) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(f) {
                switch (f.label) {
                  case 0:
                    return f.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.L_(this.D_) ];

                  case 1:
                    return s = f.sent(), u = this.platform.Yo(this.D_.ii), a = function(t, e, n) {
                        return new Jn(t, e, n);
                  ...
                  case 2:
                    return f.sent(), this.persistence = t.persistence, this.Dc = t.Dc, this.tu = t.tu, 
                    this.Cc = t.Cc, this.vu = t.vu, this.R_ = t.R_, this.O_ = t.y_, 
                    // When a user calls clearPersistence() in one client, all other clients
                    // need to be terminated to allow the delete to succeed.
                    this.persistence.h_((function() {
                ...
                return __generator(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        ...
                        return this.R_ && this.R_.stop(), [ 4 /*yield*/ , this.Cc.pu() ];

                      case 1:
                        return t.sent(), [ 4 /*yield*/ , this.Dc.pu() ];
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return this.F_(), r = new je, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return __awaiter(i, void 0, void 0, (function() {
                            var e, i, o;
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.tu.so(t) ];
                    ...
                    return this.F_(), r = new je, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return __awaiter(i, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.tu.ao(t, 
                                    /* usePreviousResults= */ !0) ];

                                  case 1:
                                    return e = n.sent(), i = new sr(t, e.co), o = i.lc(e.documents), s = i.wc(o, 
        ...
        var e = this;
        this.F_(), this.Pr.Sr((function() {
            return e.O_.fl(t), Promise.resolve();
        }));
    }, t.prototype.dl = function(t) {
        var e = this;
        ...
        var n = new je;
        return this.Pr.Sr((function() {
            return e.vu.runTransaction(e.Pr, t, n), Promise.resolve();
        })), n.promise;
    }, t;
}(), Ar = /** @class */ function() {
    function t(t) {
...
var _r = /** @class */ function() {
    ...
    return t.prototype.j_ = function(t) {
        ...
        var e = this, n = {};
        return M$1(t.fields || {}, (function(t, r) {
            n[t] = e.j_(r);
        })), n;
    }, t.prototype.z_ = function(t) {
        return new On($(t.latitude), $(t.longitude));
    ...
    function t(t) {
        ...
        hn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Xe.hh; else {
            if (t.cacheSizeBytes !== Dr && t.cacheSizeBytes < Xe.rh) throw new I$1(E$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Xe.rh);
    ...
    function t(r, i, o) {
        var s = this;
        if (void 0 === o && (o = new Ir), this.J_ = null, 
        ...
        this.rf = o, this.hf = new Rr({});
    }
    return Object.defineProperty(t.prototype, "af", {
        get: function() {
            return this.uf || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.uf = new jn(this.xo, this.hf.ignoreUndefinedProperties)), this.uf;
        },
        enumerable: !0,
        configurable: !0
        ...
        if (this.tf(), Tr(t)) return this.wf(t);
        ...
        return new Se(this.xo, this.if, this.hf.host, this.hf.ssl, this.hf.forceLongPolling);
    }, t.prototype.lf = function(t, e) {
        var n = this.ff();
        return this.ef = new Nr(be.nt(), n, this.nf, this.Z_), this.ef.start(t, e);
    }, t.sf = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new I$1(E$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return this.tf(), new Mr(new kt(U$1.H, t), this);
    ...
    return t.prototype.get = function(t) {
        ...
        var n = Br("Transaction.get", t, this.If);
        return this.mf.Ba([ n.Bo ]).then((function(t) {
            if (!t || 1 !== t.length) return _e();
            var r = t[0];
            if (r instanceof Dt) return new Or(e.If, n.Bo, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Uo);
            if (r instanceof _t) return new Or(e.If, n.Bo, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Uo);
            throw _e();
        }));
        ...
        var r = Br("Transaction.set", t, this.If);
        n = Fr("Transaction.set", n);
        var i = zr(r.Uo, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.If.af.Zo(s, o, n.mergeFields) : this.If.af.Xo(s, o);
        return this.mf.set(r.Bo, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof An ? (rn("Transaction.update", arguments, 3), 
        r = Br("Transaction.update", t, this.If), i = this.If.af.ea("Transaction.update", e, n, o)) : (nn("Transaction.update", arguments, 2), 
        r = Br("Transaction.update", t, this.If), i = this.If.af.ta("Transaction.update", e)), 
        this.mf.update(r.Bo, i), this;
    }, t.prototype.delete = function(t) {
        nn("Transaction.delete", arguments, 1);
        var e = Br("Transaction.delete", t, this.If);
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = Br("WriteBatch.set", t, this.If);
        n = Fr("WriteBatch.set", n);
        var i = zr(r.Uo, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.If.af.Zo(s, o, n.mergeFields) : this.If.af.Xo(s, o);
        return this.Rf = this.Rf.concat(u.Qo(r.Bo, pt.dt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Pf(), "string" == typeof e || e instanceof An ? (rn("WriteBatch.update", arguments, 3), 
        r = Br("WriteBatch.update", t, this.If), i = this.If.af.ea("WriteBatch.update", e, n, o)) : (nn("WriteBatch.update", arguments, 2), 
        r = Br("WriteBatch.update", t, this.If), i = this.If.af.ta("WriteBatch.update", e)), 
        this.Rf = this.Rf.concat(i.Qo(r.Bo, pt.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        nn("WriteBatch.delete", arguments, 1), this.Pf();
        var e = Br("WriteBatch.delete", t, this.If);
    ...
    return __extends(n, e), n.Tf = function(t, e, r) {
        ...
        get: function() {
            return new Cr(this.Bo.path.O(), this.firestore, this.Uo);
        },
        enumerable: !0,
        configurable: !0
        ...
        var e = U$1.G(t);
        return new Cr(this.Bo.path.child(e), this.firestore);
    }, n.prototype.isEqual = function(t) {
        ...
        on("DocumentReference.set", arguments, 1, 2), e = Fr("DocumentReference.set", e);
        var n = zr(this.Uo, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.af.Zo(i, r, e.mergeFields) : this.firestore.af.Xo(i, r);
        return this.ef.write(o.Qo(this.Bo, pt.dt()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof An ? (rn("DocumentReference.update", arguments, 2), 
        n = this.firestore.af.ea("DocumentReference.update", t, e, r)) : (nn("DocumentReference.update", arguments, 1), 
        n = this.firestore.af.ta("DocumentReference.update", t)), this.ef.write(n.Qo(this.Bo, pt.exists(!0)));
        ...
        "object" != typeof t[i] || Tr(t[i]) || (vn("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        hn("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return Tr(t[i]) ? n = t[i] : (sn("DocumentReference.onSnapshot", "function", i, t[i]), 
        ...
        var i = new Ar({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new Or(n.firestore, n.Bo, r, t.fromCache, t.hasPendingWrites, n.Uo));
                }
            },
            error: r
        ...
        var e = this;
        return on("DocumentReference.get", arguments, 0, 1), jr("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.tf().M_(e.Bo).then((function(t) {
                n(new Or(e.firestore, e.Bo, t, 
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (on("DocumentSnapshot.data", arguments, 0, 1), t = xr("DocumentSnapshot.data", t), 
        this.yf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Uo) {
                var n = new Lr(this.If, this.Bo, this.yf, this.gf, this.bf);
                return this.Uo.fromFirestore(n, t);
            }
            return new _r(this.If.xo, this.If.Ef(), t.serverTimestamps || "none", (function(t) {
                return new Sr(t, e.If);
            })).j_(this.yf.Ot());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (on("DocumentSnapshot.get", arguments, 1, 2), e = xr("DocumentSnapshot.get", e), 
        this.yf) {
            var r = this.yf.data().field(Wn("DocumentSnapshot.get", t));
            if (null !== r) return new _r(this.If.xo, this.If.Ef(), e.serverTimestamps || "none", (function(t) {
                return new Sr(t, n.If, n.Uo);
            })).j_(r);
        }
        ...
        get: function() {
            return new Sr(this.Bo, this.If, this.Uo);
        },
        enumerable: !0,
        configurable: !0
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i, o = fn("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, n), s = Wn("Query.where", e);
        if (s.Y()) {
        ...
        i = this.firestore.af.sa("Query.where", r, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ "in" /* IN */ === o);
        var f = Ut.create(s, o, i);
        ...
        var i = Wn("Query.orderBy", e), o = new Ct(i, r);
        ...
        return this.firestore === e.firestore && this.vf.isEqual(e.vf);
    ...
    t.prototype.Lf = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                var u = this.vf.path.child(U$1.G(s));
                ...
                var h = this.firestore.af.sa(t, s);
                i.push(h);
            }
        }
        return new qt(i, n);
        ...
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || Tr(t[i]) || (vn("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        hn("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), Tr(t[i]) ? n = t[i] : (sn("Query.onSnapshot", "function", i, t[i]), un("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        ...
        var i = new Ar({
            next: function(t) {
                e.next && e.next(new qr(n.firestore, n.vf, t, n.Uo));
            },
            error: r
        ...
        var e = this;
        return on("Query.get", arguments, 0, 1), jr("Query.get", t), this.Of(this.vf), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.tf().x_(e.vf).then((function(t) {
                n(new qr(e.firestore, e.vf, t, e.Uo));
            }), r) : e.pf(n, r, t);
        }));
    ...
    t.prototype.Cf = function(t) {
        if ("string" == typeof t) {
            ...
            var e = this.vf.path.child(U$1.G(t));
    ...
    function t(t, e, n, r) {
        ...
        this.metadata = new Pr(n.hasPendingWrites, n.fromCache);
    }
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new Lr(this.If, t.key, t, this.metadata.fromCache, this.Mf.ns.has(t.key), this.Uo);
    }, t;
}(), Cr = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.M() ? null : new Sr(new O$1(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
    }), Object.defineProperty(n.prototype, "path", {
        ...
        var e = U$1.G(t);
        return Sr.Tf(this.vf.path.child(e), this.firestore, this.Uo);
...
function Fr(t, e) {
    ...
    if (vn(t, e, [ "merge", "mergeFields" ]), hn(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        ...
        return "string" == typeof t || t instanceof An;
...
var Wr = Qr(Vr, "Use firebase.firestore() instead."), Hr = Qr(kr, "Use firebase.firestore().runTransaction() instead."), Yr = Qr(Ur, "Use firebase.firestore().batch() instead."), Kr = Qr(Sr, "Use firebase.firestore().doc() instead."), Xr = Qr(Or), $r = Qr(Lr), Jr = Qr(Mr), Zr = Qr(qr), ti = Qr(Cr, "Use firebase.firestore().collection() instead."), ei = Qr(Sn, "Use FieldValue.<field>() instead."), ni = Qr(Nn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), ri = {
    Firestore: Wr,
    GeoPoint: On,
    Timestamp: R$1,
    Blob: ni,
    ...
    Commit: "commit"
}, ai = "gl-js/ fire/" + w$1, hi = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.od = function(t, e) {
        ...
        var d = i.createWebChannel(p, o), y = !1, v = !1, b = new si({
            Xf: function(t) {
 ...
 */
    !function(t, e) {
        t.INTERNAL.registerComponent(new Component("firestore", (function(t) {
            return function(t, e) {
                return new Vr(t, e, new Ir);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, ri)));
    }(t), t.registerVersion("@firebase/firestore", "1.15.0");
}
...
be.an(new (/** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "document", {
        ...
        return Promise.resolve(new hi(t));
    }, t.prototype.C_ = function() {
        return oi.Yf() ? new oi : new ii;
